...
// from the finding contract core promises. Shared by both lint tools' `outputSchema` so there is one mirror,
// not two.
//
// The key set has not changed; `helpUri`'s *value* has. It used to cross the wire as a bare
