...
// degrades to a sanitized `INTERNAL_ERROR`, losing exactly the actionable text M6 exists to preserve
...
// `shared/tool-context.ts` became the second at P14.01). Still deliberately not promoted to core: the
