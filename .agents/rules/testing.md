...
These four categories are the standing answer. Each names a class of defect that in-process tests structurally cannot see, so a subsystem missing one is missing it visibly rather than silently.
