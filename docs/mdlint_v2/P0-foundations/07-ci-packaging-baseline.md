...
- **Previous:** [P0.05 — cli](05-cli-package-commander.md) and [P0.06 — mcp-server](06-mcp-server-skeleton.md) produced the two host packages on top of core; all three now build.
- **Next:** [P0.08 — Phase exit verification](08-exit-verification.md) runs the full green check and documents the layout.
- **Depends on:** P0.05, P0.06 · **Blocks:** P0.08.

## Inputs (from previous work)

- Three buildable packages (`core`, `cli`, `mcp-server`) and the root workspace scripts from P0.02.
