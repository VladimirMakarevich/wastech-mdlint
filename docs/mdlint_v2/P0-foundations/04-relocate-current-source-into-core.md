...
Lift-and-shift the current implementation's reusable modules from `src/*` into `packages/core/src/*`
...
Modules to relocate from the current implementation (all currently clean and reusable — see the
